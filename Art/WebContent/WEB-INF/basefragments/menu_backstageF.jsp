	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapsePages3" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="<c:url value='/03/cms/reservation/create'/>">建立商店預約</a>
				<a class="collapse-item" href="<c:url value='/03/cms/reservation/search'/>">查詢商店預約</a>
				<a class="collapse-item" href="<c:url value='/03/cms/reservation/update'/>">修改商店預約</a>
				<a class="collapse-item" href="<c:url value='/03/cms/reservation/delete'/>">刪除商店預約</a>
			</div>
		</div></li>

	<!-- 藝文商店服務 -->
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		data-toggle="collapse" data-target="#collapsePages3.5"
		aria-expanded="true" aria-controls="collapsePages"> <i
			class="fas fa-store"></i> <span>藝文商店服務</span>
	</a>
		<div id="collapsePages3.5" class="collapse"
			aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<div class="collapse-divider"></div>
				<h6 class="collapse-header">藝文商店資訊:</h6>
				<a class="collapse-item" href="<c:url value='/03/cms/shop/index.ctrl'/>">管理藝文商店</a>
