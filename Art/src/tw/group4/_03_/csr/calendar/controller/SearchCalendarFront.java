...
@Controller
public class SearchCalendarFront {

	@Autowired
	private CreativeShopService css;

	@RequestMapping(path = "/03/csr/calendar/searchShopByShopNameAndReservation.ctrl", method = RequestMethod.POST)
	public String searchShopByShopNameAndReservation(@RequestParam(name = "shopName") String shopName,
		...
		return IdentityFilter.loginID+"03/csr_calendar/search_shop";
	}
