...
public class CreateCalendarFront {
	...
	@RequestMapping(path = "/03/csr/calendar/createCalendarConfirm.ctrl", method = RequestMethod.POST)
	public String createCalendarConfirm( 
		...
		return IdentityFilter.loginID+"03/csr_calendar/create_confirm";
	}

	@RequestMapping(path = "/03/csr/calendar/createCalendar.ctrl", method = RequestMethod.POST)
	public String createCalendar( 
		...
		return IdentityFilter.loginID+"03/csr_calendar/create_return";
	}
