...
public class RedirectShopControllerFront {
	...
	@RequestMapping(path = "/03/csr/shop/myShop.ctrl", method = RequestMethod.POST)
	public String redirectToMyShop(HttpSession session, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_shop/my_shop";
	}

	@RequestMapping(path = "/03/csr/shop/createConfirm.ctrl", method = RequestMethod.POST)
	public String redirectToCreateShop(HttpSession session, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_shop/create_confirm";
	}

	@RequestMapping(path = "/03/csr/shop/myShopDetails.ctrl", method = RequestMethod.POST)
	public String shopDetails(@RequestParam(name = "shopId") String shopId, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_shop/shop_details";
	}
