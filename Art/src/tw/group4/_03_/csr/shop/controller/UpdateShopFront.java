...
public class UpdateShopFront {
	...
	@RequestMapping(path = "/03/csr/shop/updateShopByShopId.ctrl", method = RequestMethod.POST)
	private String updateShopByShopId(@RequestParam(name = "shopId") String shopId, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_shop/update_confirm";
	}
	
	@RequestMapping(path = "/03/csr/shop/updateShop.ctrl", method = RequestMethod.POST)
	private String updateShop( 
		...
		return IdentityFilter.loginID+"03/csr_shop/update_return";
	}
