...
public class UpdateReservationFront {
	...
	@RequestMapping(path = "/03/csr/reservation/updateReservationByNo.ctrl", method = RequestMethod.POST)
	private String updateReservationByNo(@RequestParam(name = "reservationNo") String reservationNo, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_reservation/update_confirm";
	}

	@RequestMapping(path = "/03/csr/reservation/updateReservation.ctrl", method = RequestMethod.POST)
	private String updateReservation( 
		...
		return IdentityFilter.loginID+"03/csr_reservation/update_return";
	}

	@RequestMapping(path = "/03/csr/reservation/updateReservationByMemberName.ctrl", method = RequestMethod.POST)
...
//				System.out.println(reservationSerachMsg);
		...
		return IdentityFilter.loginID+"03/csr_reservation/update_by_name";
	}

	@RequestMapping(path = "/03/csr/reservation/updateReservationByShopName.ctrl", method = RequestMethod.POST)
