...
public class SearchReservationFront {
	...
	@RequestMapping(path = "/03/csr/reservation/searchReservationByNo.ctrl", method = RequestMethod.POST)
	public String searchReservationByNo(@RequestParam(name = "reservationNo") String reservationNo, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_reservation/search_return";

	}
	
	@RequestMapping(path = "/03/csr/reservation/searchReservationByMemberName.ctrl", method = RequestMethod.POST)
	...
	@RequestMapping(path = "/03/csr/reservation/searchReservationByShopName.ctrl", method = RequestMethod.POST)
	...
	@RequestMapping(path = "/03/csr/reservation/searchAllReservations.ctrl", method = RequestMethod.POST)
