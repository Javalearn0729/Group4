...
public class ReservationDetailsFront {
	...
	@RequestMapping(path = "/03/csr/reservation/checkReservationDetails.ctrl", method = RequestMethod.POST)
	public String checkReservationDetails(@RequestParam(name = "reservationNo") String reservationNo, Model m) {
		...
		return IdentityFilter.loginID+"03/csr_reservation/reservation_details";
